    ...
    <section class="row">
                    ...
                    <thead>
                        ...
                        <tr>
                          ...
                          <!--  <th scope="col">Available</th>
                            ...
                            <th scope="col" class="text-center">Pricio</th>
                            <th scope="col"></th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        <section class="col mb-2">
            <article class="row">
                ...
                <a href='{{route('men')}}' class="btn btn-block btn-light">Continua Reservando</a>
                </section>
                <section class="col-sm-12 col-md-6 text-right">
                    <button class="btn btn-lg btn-block btn-success text-uppercase">Verificar</button>
                </section>
            </article>
            <br>
        </section>
            ...
            <div class='container mb-5 mt-5'>
                <h2 class='text-center mb-5 mt-5'>Aun No tienes Ninguna reservacion </h2>
            </div>
            @endif  
