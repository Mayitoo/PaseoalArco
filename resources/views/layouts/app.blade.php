...
<body>
    ...
    <header id="main-header" class="main-header">
        ...
        <nav class="main-nav">
            ...
            <a href="{{route('women')}}">Lancha</a>
            <a href="{{route('men')}}">Yates</a>
            <a href="{{route('kids')}}">Buseo</a>
        ...
        <footer class="main-footer">
            <nav>
                ...
                <article class="column-2 footer-article">
                    ...
                    <a href="Mario:Mayitoo4444@gmail.com"?subjet="Mensaje desde el sitio web" class="contact-logo"><i class="fas fa-envelope-square i"></i></a>
                </article>
